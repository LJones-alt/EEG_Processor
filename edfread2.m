function [hdr, record] = edfread2(EEG_short, varargin)
...
if ~nargin
    [EEG_short] = uigetfile({'*.edf','European Data Format Files'});
if ~iscell(EEG_short)
    if length(EEG_short) <= 1 && EEG_short == 0
        return;
    end
end
